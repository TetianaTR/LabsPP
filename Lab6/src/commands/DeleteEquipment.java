...
public class DeleteEquipment implements Interface {
    ...
    ArrayList<EquipList> equipmentlist;
    ArrayList<WeaponList> weaponList;
    @Override
    public ResultOfCommand<String> execute() {
        ...
        if(equipmentlist.size()==0 && weaponList.size()==0){
            ...
            ResultOfCommand<String> result = new ResultOfCommand<String>("Failed","Nothing to delete",false);
            return result;
        }
    ...
    public DeleteEquipment(KnightInfo knights, ArrayList<EquipList> equipmentlist,ArrayList<WeaponList> weaponList){
