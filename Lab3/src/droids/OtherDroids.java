...
public class OtherDroids extends BaseDroid {
    ...
    public void setdroid(int type) {
        switch (type) {
            case (1):
                this.healthigh = (int) this.getHealth() / 3;
                this.amhealing = (int) this.getDamage() /2;
                System.out.println("You chose Healer-droid");
                break;
            case (2):
                this.setDamage(this.getDamage()+(int) this.getDamage() / 2);
                System.out.println("You chose Highdamage droid");
                break;
            case (3):
                this.setDamage(this.getAttackTime()- (int) this.getAttackTime() / 2);
